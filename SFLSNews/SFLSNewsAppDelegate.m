...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIBarButtonItem *newsBackButton=[[UIBarButtonItem alloc]initWithTitle:@"图文资料" style:UIBarButtonItemStylePlain target:nil action:nil];
    newsNav.tabBarItem.image=[UIImage imageNamed:@"texticon.png"];
