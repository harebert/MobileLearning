...
- (void)engineAlreadyLoggedIn:(WBEngine *)engine{           //微博已经登录
    ...
    NSString *sentString=[NSString stringWithFormat:@"我正在初中信息科技移动学习客户端学习知识点：%@，邀请你和我一起哦！",newsDetail_newsTitle.text];
    WBSendView *newSendView=[[WBSendView alloc]initWithAppKey:SINA_WEIBO_APP_KEY appSecret:SINA_WEIBO_APP_SECRET text:sentString image:postImage];
